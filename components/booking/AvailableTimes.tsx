...
const AvailableTimes: FC<AvailableTimesProps> = ({
  ...
  return (
    <div className="mt-8 text-center sm:pl-4 sm:mt-0 sm:w-1/3 md:-mb-5">
      <div className="mb-4 text-lg font-light text-left ">
        <span className="w-1/2 bd-blue">
            ...
            return (
              <div key={slot.time.format()}>
                <Link href={bookingUrl}>
                  <a
                    className="block py-4 mb-2 font-medium bg-white border rounded-sm dark:bg-gray-600 text-primary-500 dark:text-neutral-200 border-primary-500 dark:border-transparent hover:text-white hover:bg-primary-500 dark:hover:border-black dark:hover:bg-black"
                    data-testid="time">
